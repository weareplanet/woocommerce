...
/**
 *
 * WC_WeArePlanet_Entity_Refund_Job Class
 *
 * WeArePlanet
 ...
 * @method \WeArePlanet\Sdk\Model\RefundCreate get_refund()
 * @method void set_refund( \WeArePlanet\Sdk\Model\RefundCreate  $refund)
 * @method void set_failure_reason(map[string,string] $reasons)
 */
class WC_WeArePlanet_Entity_Refund_Job extends WC_WeArePlanet_Entity_Abstract {
	...
	protected static function get_field_definition() {
		return array(
			'external_id'    => WC_WeArePlanet_Entity_Resource_Type::STRING,
			...
			'wc_refund_id'   => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'refund'         => WC_WeArePlanet_Entity_Resource_Type::OBJECT,
	...
	protected static function get_table_name() {
		return 'wc_weareplanet_refund_job';
	}
