...
/**
 *
 * WC_WeArePlanet_Entity_Transaction_Info Class
 *
 * WeArePlanet
 ...
 */
class WC_WeArePlanet_Entity_Transaction_Info extends WC_WeArePlanet_Entity_Abstract {
	...
	protected static function get_field_definition() {
		return array(
			'transaction_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'state' => WC_WeArePlanet_Entity_Resource_Type::STRING,
			'space_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'space_view_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'language' => WC_WeArePlanet_Entity_Resource_Type::STRING,
			'currency' => WC_WeArePlanet_Entity_Resource_Type::STRING,
			'authorization_amount' => WC_WeArePlanet_Entity_Resource_Type::DECIMAL,
			'image' => WC_WeArePlanet_Entity_Resource_Type::STRING,
			'image_base' => WC_WeArePlanet_Entity_Resource_Type::STRING,
			'labels' => WC_WeArePlanet_Entity_Resource_Type::OBJECT,
			'payment_method_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'connector_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'order_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'order_mapping_id' => WC_WeArePlanet_Entity_Resource_Type::INTEGER,
			'failure_reason' => WC_WeArePlanet_Entity_Resource_Type::OBJECT,
			'user_failure_message' => WC_WeArePlanet_Entity_Resource_Type::STRING,
			'locked_at' => WC_WeArePlanet_Entity_Resource_Type::DATETIME,
		);
	}
	...
	protected static function get_table_name() {
		return 'wc_weareplanet_transaction_info';
	}
