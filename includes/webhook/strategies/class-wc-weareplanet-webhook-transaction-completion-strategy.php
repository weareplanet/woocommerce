...
class WC_WeArePlanet_Webhook_Transaction_Completion_Strategy extends WC_WeArePlanet_Webhook_Strategy_Base {
	 ...
	 * @param \WeArePlanet\Sdk\Model\TransactionCompletion $completion The transaction completion data.
	 * @return void
	 */
	protected function success( WC_Order $order, \WeArePlanet\Sdk\Model\TransactionCompletion $completion ) {
	 ...
	 *
	 * @param WC_Order $order The associated WooCommerce order.
	 * @param \WeArePlanet\Sdk\Model\TransactionCompletion $completion The transaction completion data that failed.
	 * @return void
	 */
	protected function failed( WC_Order $order, \WeArePlanet\Sdk\Model\TransactionCompletion $completion ) {
		$completion_job = WC_WeArePlanet_Entity_Completion_Job::load_by_completion( $completion->getLinkedSpaceId(), $completion->getId() );
		if ( ! $completion_job->get_id() ) {
			$completion_job = WC_WeArePlanet_Entity_Completion_Job::load_running_completion_for_transaction(
				$completion->getLinkedSpaceId(),
