...
class WC_WeArePlanet_Webhook_Delivery_Indication_Strategy extends WC_WeArePlanet_Webhook_Strategy_Base {
	 ...
	 * @return void
	 */
	public function bridge_process_order_related_inner( WC_Order $order, \WeArePlanet\Sdk\Model\DeliveryIndication $delivery_indication, WC_WeArePlanet_Webhook_Request $request ) {
	 ...
	 * @return void
	 */
	protected function process_order_related_inner( WC_Order $order, \WeArePlanet\Sdk\Model\DeliveryIndication $delivery_indication, WC_WeArePlanet_Webhook_Request $request, $legacy_mode = false ) {
	...
	protected function review( WC_Order $order ) {
		...
		$default_status = WC_WeArePlanet_Helper::map_status_to_current_mode( 'wearep-manual' );
		$status = apply_filters( 'wc_weareplanet_manual_task_status', $default_status, $order );
		$status = WC_WeArePlanet_Helper::map_status_to_current_mode( $status );
