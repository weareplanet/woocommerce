...
final class WC_WeArePlanet_Blocks_Support extends AbstractPaymentMethodType {
	...
	public function initialize() {
		$this->settings['space_id'] = get_option( WooCommerce_WeArePlanet::CK_SPACE_ID );
	}
	...
	public function get_payment_method_script_handles() {
		...
		return [ 'WooCommerce_WeArePlanet_blocks_support' ];
	}
	...
	static public function get_payment_methods() {
		...
		$payments_list = array_map(function(WC_WeArePlanet_Gateway $payment_gateway) {
			return [
				...
				'integration_mode' => (get_option( WooCommerce_WeArePlanet::CK_INTEGRATION ) == WC_WeArePlanet_Integration::LIGHTBOX ) ? 'lightbox' : 'iframe',
	...
	static public function enqueue_portal_scripts() {
		...
		if (( get_option( WooCommerce_WeArePlanet::CK_INTEGRATION ) == WC_WeArePlanet_Integration::LIGHTBOX )) {
