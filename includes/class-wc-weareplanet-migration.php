...
class WC_WeArePlanet_Migration {
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_WEAREPLANET_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.weareplanet.com/weareplanet/woocommerce/3.1.0/docs/en/documentation.html" aria-label="' . esc_html__( 'View Documentation', 'woo-weareplanet' ) . '">' . esc_html__( 'Documentation', 'woo-weareplanet' ) . '</a>',
			);
	...
	public static function update_1_0_6_shorten_table_names() {
		...
		$table_rename_map = array(
			"{$wpdb->prefix}woocommerce_weareplanet_attribute_options" => "{$wpdb->prefix}weareplanet_attribute_options",
			"{$wpdb->prefix}woocommerce_weareplanet_completion_job" => "{$wpdb->prefix}weareplanet_completion_job",
			"{$wpdb->prefix}woocommerce_weareplanet_method_configuration" => "{$wpdb->prefix}weareplanet_method_config",
			"{$wpdb->prefix}woocommerce_weareplanet_refund_job" => "{$wpdb->prefix}weareplanet_refund_job",
			"{$wpdb->prefix}woocommerce_weareplanet_token_info" => "{$wpdb->prefix}weareplanet_token_info",
			"{$wpdb->prefix}woocommerce_weareplanet_transaction_info" => "{$wpdb->prefix}weareplanet_transaction_info",
			"{$wpdb->prefix}woocommerce_weareplanet_void_job" => "{$wpdb->prefix}weareplanet_void_job",
		);
