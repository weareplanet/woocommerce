...
class WC_WeArePlanet_Migration {
	...
	private static function check_requirements() {
		...
		if ( ! empty( $errors ) ) {
			...
			$message = printf(
				...
				esc_html__( 'Please check the following requirements before activating:', 'woo-weareplanet' ),
				esc_html__( $error_list ) //phpcs:ignore
			);
			// phpcs:ignore
			wp_die( $message, esc_html__( 'Could not activate plugin WeArePlanet.', 'woo-weareplanet' ), array( 'back_link' => true ) );
			return;
		}
	}
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_WEAREPLANET_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.weareplanet.com/weareplanet/woocommerce/3.3.1/docs/en/documentation.html" aria-label="' . esc_html__( 'View Documentation', 'woo-weareplanet' ) . '">' . esc_html__( 'Documentation', 'woo-weareplanet' ) . '</a>',
			);
