...
class WC_WeArePlanet_Migration {
	...
	public static function plugin_row_meta( $links, $file ) {
		if ( WC_WEAREPLANET_PLUGIN_BASENAME === $file ) {
			$row_meta = array(
				'docs' => '<a href="https://plugin-documentation.weareplanet.com/weareplanet/woocommerce/3.3.20/docs/en/documentation.html" aria-label="' . esc_html__( 'View Documentation', 'woo-weareplanet' ) . '">' . esc_html__( 'Documentation', 'woo-weareplanet' ) . '</a>',
			);
