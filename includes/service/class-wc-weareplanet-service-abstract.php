...
/**
 *
 * WC_WeArePlanet_Service_Abstract Class
 *
 * WeArePlanet
 ...
 * WC_WeArePlanet_Service_Abstract Class.
 */
abstract class WC_WeArePlanet_Service_Abstract {
	/**
	 * Instances.
	 *
	 * @var array
	 ...
	 *
	 * @param \WeArePlanet\Sdk\Model\DatabaseTranslatedString $translated_string translated string.
	 * @return string[]
	 */
	protected function get_translations_array( \WeArePlanet\Sdk\Model\DatabaseTranslatedString $translated_string ) {
		$translations = array();
	...
	protected function get_currency_fraction_digits( $currency_code ) {
		return WC_WeArePlanet_Helper::instance()->get_currency_fraction_digits( $currency_code );
	}
	 ...
	 */
	protected function create_entity_filter( $field_name, $value, $operator = \WeArePlanet\Sdk\Model\CriteriaOperator::EQUALS ) {
	 ...
	 */
	protected function create_entity_order_by( $field_name, $sort_order = \WeArePlanet\Sdk\Model\EntityQueryOrderByType::DESC ) {
