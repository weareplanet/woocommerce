...
class WC_WeArePlanet_Service_Transaction extends WC_WeArePlanet_Service_Abstract {
	...
	protected function get_transaction_service() {
		if ( is_null( $this->transaction_service ) ) {
			$this->transaction_service = new \WeArePlanet\Sdk\Service\TransactionService( WC_WeArePlanet_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_iframe_service() {
		if ( is_null( $this->transaction_iframe_service ) ) {
			$this->transaction_iframe_service = new \WeArePlanet\Sdk\Service\TransactionIframeService( WC_WeArePlanet_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_lightbox_service() {
		if ( is_null( $this->transaction_lightbox_service ) ) {
			$this->transaction_lightbox_service = new \WeArePlanet\Sdk\Service\TransactionLightboxService( WC_WeArePlanet_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_payment_page_service() {
		if ( is_null( $this->transaction_payment_page_service ) ) {
			$this->transaction_payment_page_service = new \WeArePlanet\Sdk\Service\TransactionPaymentPageService( WC_WeArePlanet_Helper::instance()->get_api_client() );
		}
	...
	protected function get_charge_attempt_service() {
		if ( is_null( $this->charge_attempt_service ) ) {
			$this->charge_attempt_service = new \WeArePlanet\Sdk\Service\ChargeAttemptService( WC_WeArePlanet_Helper::instance()->get_api_client() );
		}
	...
	protected function get_transaction_line_item_version_service() {
		if ( is_null( $this->transaction_line_item_version_service ) ) {
			$this->transaction_line_item_version_service = new \WeArePlanet\Sdk\Service\TransactionLineItemVersionService( WC_WeArePlanet_Helper::instance()->get_api_client() );
		}
