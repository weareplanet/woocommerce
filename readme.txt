...
Additional documentation for this plugin is available [here](https://plugin-documentation.weareplanet.com/weareplanet/woocommerce/2.1.23/docs/en/documentation.html).
