...
class RefundCommentService {
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \WeArePlanet\Sdk\Model\RefundCommentCreate $entity The comment object which should be created. (required)
	 * @throws \WeArePlanet\Sdk\ApiException
	 * @throws \WeArePlanet\Sdk\VersioningException
	 * @throws \WeArePlanet\Sdk\Http\ConnectionException
	 * @return \WeArePlanet\Sdk\Model\RefundComment
	 ...
	 *
	 * @param int $space_id  (required)
	 * @param \WeArePlanet\Sdk\Model\RefundCommentActive $entity The comment object with the properties which should be updated. (required)
	 * @throws \WeArePlanet\Sdk\ApiException
	 * @throws \WeArePlanet\Sdk\VersioningException
	 * @throws \WeArePlanet\Sdk\Http\ConnectionException
	 * @return \WeArePlanet\Sdk\Model\RefundComment
