...
class Transaction implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param \WeArePlanet\Sdk\Model\ChargeAttemptEnvironment $authorization_environment The environment in which the transaction was authorized.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $billing_address The address associated with the payment method for invoicing and transaction processing purposes.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionCompletionBehavior $completion_behavior The behavior that controls when the transaction is completed.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\CustomersPresence $customers_presence The customer's presence indicates whether and in what way the transaction's customer is present. Default is VIRTUAL_PRESENT.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionEnvironmentSelectionStrategy $environment_selection_strategy The strategy for determining whether the transaction is to be processed in the test or production environment.
     *
     * @return $this
     */
     ...
     * Sets failure_reason
     *
     * @param \WeArePlanet\Sdk\Model\FailureReason $failure_reason The reason for the failure of the transaction.
     *
     * @return $this
     */
     ...
     * Sets group
     *
     * @param \WeArePlanet\Sdk\Model\TransactionGroup $group The group that the transaction belongs to.
     *
     * @return $this
     */
     ...
     * Sets line_items
     *
     * @param \WeArePlanet\Sdk\Model\LineItem[] $line_items The line items purchased by the customer.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\PaymentConnectorConfiguration $payment_connector_configuration The payment connector configuration that was used to authorize the transaction.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\Address $shipping_address The address to where the order will be shipped.
     *
     * @return $this
     */
     ...
     * Sets terminal
     *
     * @param \WeArePlanet\Sdk\Model\PaymentTerminal $terminal The payment terminal through which the payment was processed.
     *
     * @return $this
     */
     ...
     * Sets token
     *
     * @param \WeArePlanet\Sdk\Model\Token $token The payment token that should be used to charge the customer.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TokenizationMode $tokenization_mode The tokenization mode specifies whether and how the tokenization of payment information is applied to the transaction.
     *
     * @return $this
     */
     ...
     *
     * @param \WeArePlanet\Sdk\Model\TransactionUserInterfaceType $user_interface_type The type of user interface the customer used to provide the payment information.
     *
     * @return $this
     */
