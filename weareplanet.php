...
if ( ! class_exists( 'WooCommerce_WeArePlanet' ) ) {
	...
	final class WooCommerce_WeArePlanet {
		...
		public function load_plugin_textdomain() {
			...
			$locale = apply_filters( 'plugin_locale', $locale, 'woo-weareplanet' );

			load_textdomain( 'woo-weareplanet', WP_LANG_DIR . '/woo-weareplanet/woo-weareplanet' . $locale . '.mo' );
			load_plugin_textdomain( 'woo-weareplanet', false, plugin_basename( __DIR__ ) . '/languages' );
		}
	...
	public function valid_order_statuses_for_payment( $statuses, $order = null ) { //phpcs:ignore
		...
		public function woocommerce_attribute_added( $attribute_id, $data ) { //phpcs:ignore
			if ( did_action( 'product_page_product_attributes' ) ) {
				...
				$option_set = isset( $_POST['weareplanet_attribute_option_send'] );
